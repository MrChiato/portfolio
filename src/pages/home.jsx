        ...
        <div id="menu">
          <div id="tag-items">
            <span className='plain-text'>&lt;div id=<span className='white-text'>"menu"</span>&gt;</span>
              <div id="menu-items">
                <a href="https://mrchiato.github.io/DKSPFMap/" target="_blank" className="menu-item"><span className='tag-text'>&lt;a&gt;</span>Current Project<span className='tag-text'>&lt;/a&gt;</span></a>
